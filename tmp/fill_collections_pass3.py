#!/usr/bin/env python3
"""
Pass 3: Fix failure modes and related keywords with correct
whitespace patterns (no blank line before code fence in failures).
"""
...
def apply(filepath):
    ...
    # Failure modes: no blank line before code fence in file
