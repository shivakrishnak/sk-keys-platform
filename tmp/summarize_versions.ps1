...
Write-Host ""
Write-Host "Top mismatches:"
$csv | Where-Object { $_.NeedsUpdate -eq "YES" } | Select-Object -First 5 FileName, CurrentVersion, CorrectVersion, HasV21, HasV30, HasV31, HasV4 | Format-Table -AutoSize
